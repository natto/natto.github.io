...
** cognitive distance
   ...
   inspired by programming. there are several examples

   1. dependency (hell) resolution
      if you've decided to do some task, but face a bunch of barriers in
      between (be it dependency related or bug fixing one by one due to the
         compiler not being able to catch them at compile time, like in
      python), how many onion layers can you go through while keeping the
      original goal clearly in mind.
   2. video game quests
      load times, intervening events, say in skyrim, and you have battles
      and minions battling you in between. same, onion layers
   3. code and documentation
      take a look at
      https://developers.google.com/closure/compiler/docs/js-for-compiler
      where the type hinting for variables is in comments.
      this increases cognitive distance between the intention of adding
      a type to a variable, and the actual variable. if for example you
      were writing some code, created var X, thought "I need to add a type
      to this variable", scroll somewhere else, write a comment (without
      a comment expander template in the editor, so you're writing raw
      comment), and return from typing var X.
   
      need a task that systematically varies the cognitive distance and see
      how that affects goal tracking
...
** cunningham's law
   ...
   this is intuitively true when thought in terms of ego. should design an experiment for it
...
*** rubik's cube: feliks zemdeg's 7-second barrier broken in 2010

    #+BEGIN_QUOTE
    It's a weird thing in cubing - it seems like once someone breaks a time barrier, then everyone else is suddenly able to do so.
    #+END_QUOTE
    http://www.reddit.com/r/IAmA/comments/15v3av/i_am_feliks_zemdegs_rubiks_cube_world_record/c7q47df

*** skateboarding: tony hawk's 900 barrier broken in 1999
    ...
    #+END_QUOTE
    http://www.reddit.com/r/IAmA/comments/10vx7o/iam_tony_hawk_professional_skateboarder_videogame/c6h4spc

*** figure skating: ando miki's quadruple jump in 2002

    has not been replicated by others

**** TODO examine the physics of this move and ando's condition
...
** Cristiano Ronaldo - Tested To The Limit
   ...
   http://www.youtube.com/watch?v=vNJXx2NX2rk#aid=P-LQJUAD4SE

* talking funny

  very interesting
  
  https://www.youtube.com/watch?v=OKY6BGcx37k#t=195

** Kevin Hart & Louis CK -- the audience doesn't know if you did poorly. Every show is either really good, or great

   you are your toughest critic, you are in competition with yourself
   https://youtu.be/HCtlZmCH8Q0?t=198


* coaches and masters

  people who teach people above their level

  and what does it take to understand "that level"

  

* handoff process

  this happens when an especially productive (say) programmer who leads a project largely out of their own effort

  then a following gathers around, which accelerates the evolution of that project.

  suppose the same first programmer decides to stop. what is lost is possibly not just the main output, and the ship's rudder,
  but also, when nobody is able to fill the old shoes, the handoff process fails. we want to observe these instances and
  study them.

* embodiment through skill

  dawkins & tyson talk about this phenomenon (mathematics, pilots, surgeons, astronomers)
  https://www.youtube.com/watch?v=9RExQFZzHXQ#t=1060


  
* shower and creativity and related phenomena

** seymour cray's visits from elves during tunnel digging

   http://en.wikipedia.org/wiki/Seymour_Cray#Technical_approaches
...
* net promoter score
  ...
  richter /the ultimate question/

* Mullainathan -- Scarcity: a talk for people too busy to attend talks

  https://www.youtube.com/watch?v=u6_scuce5TA&feature=youtu.be&t=4876
